...
const file_role_role_proto_rawDesc = "" +
	...
	"\x04role\x18\x01 \x01(\v2\f.common.RoleR\x04role2\xac\x01\n" +
	"\vRoleService\x123\n" +
	...
	"\x06Update\x12\x13.role.UpdateRequest\x1a\x14.role.UpdateResponseB;Z9github.com/rednek21/SKMEnergoProto/gen/go/proto/role;roleb\x06proto3"
...
var file_role_role_proto_depIdxs = []int32{
	...
	3, // 5: role.RoleService.Create:output_type -> role.CreateResponse
	1, // 6: role.RoleService.GetAll:output_type -> role.GetAllResponse
	5, // 7: role.RoleService.Update:output_type -> role.UpdateResponse
